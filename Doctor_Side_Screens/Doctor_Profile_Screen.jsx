...
export const Doctor_Profile_Screen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      >
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate("Update_Doctor_Screen")}
        >
          <Icon
            name="create-outline"
            size={30}
      ...
      <ScrollView>
        ...
        >
          ...
          >
            <Text
              numberOfLines={1}
              style={{ fontSize: wp(3), color: "red", fontWeight: 900 }}
            >
              Work with
            </Text>{" "}
            {Hospital_name}
        ...
        >
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate("Doctor_History_Section_Screen")}
            style={{
...
export default Doctor_Profile_Screen;
